...
?>
  <script type="text/javascript" src="js/graficaDistribucionAreas.js"></script>
 <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Distribucion Por Areas</h1>
                  ...
                  <div class="row">
                    ...
                    <div class="card-body">
                        <table class="table table-bordered table-hover">
                            <tbody id="listadoDistribucionAreas" style="width: 50px; text-align: center">
                            <!-- LISTADO DE AREAS -->
                            </tbody>
                        </table>
                    </div>
